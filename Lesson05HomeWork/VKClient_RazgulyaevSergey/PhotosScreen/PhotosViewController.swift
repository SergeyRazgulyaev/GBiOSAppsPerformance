...
extension PhotosViewController: UICollectionViewDataSource {
    ...
    func configureCell(indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let photoDate = dateTranslator(timeToTranslate: oneFriendPhotosFromRealm![indexPath.row].date)
        ...
        cell.configureCellUI(photoCardImage: (UIImage(data: data) ?? UIImage(systemName: "tortoise.fill"))!, photoNumberLabelText: photoNumber, photoDateLabelText: photoDate)
