...
extension AvailableGroupsViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configure(titleLabelText: groups.availableGroupName, availableGroupsAvatarImage: (groups.availableGroupAvatar ?? UIImage(systemName: "tortoise.fill"))!)
//        cell.titleLabel.text = groups.availableGroupName
//        cell.availableGroupsAvatarImageView.image = groups.availableGroupAvatar
